...
export function TokenBridge({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <Group x={414} y={44} w={330} h={256} label='Base' tone='accent' />
      ...
      {/* The label carries an opaque plate, so it survives sitting across the
          L1 group boundary at x=346 instead of being struck through by it. */}
